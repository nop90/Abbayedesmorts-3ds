...
APP_TITLE		:= Abbaye des morts 
APP_DESCRIPTION	:= A platform game in retro Spectrum style
...
LIBS	:=  -lSDL_net -lSDL_mixer -lmikmod -lmad -lvorbisidec -logg -lSDL_ttf -lfreetype -lSDL_image -lSDL -lpng -ljpeg -lz -lcitro3d -lctru -lm
